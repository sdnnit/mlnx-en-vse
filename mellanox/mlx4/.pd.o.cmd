cmd_/usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/pd.o := gcc -Wp,-MD,/usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/.pd.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/4.4.7/include \
...
-I/usr/src/kernels/2.6.32-573.3.1.el6.x86_64/arch/x86/include \
-Iarch/x86/include/generated \
 -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -O2 -m64 -mtune=generic -mno-red-zone -mcmodel=kernel -funit-at-a-time -maccumulate-outgoing-args -fstack-protector -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -DCONFIG_AS_CFI_SECTIONS=1 -DCONFIG_AS_AVX=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -Wframe-larger-than=2048 -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -pg -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fno-dwarf2-cfi-asm -fconserve-stack  -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(pd)"  -D"KBUILD_MODNAME=KBUILD_STR(mlx4_core)" -D"DEBUG_HASH=51" -D"DEBUG_HASH2=37" -c -o /usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/.tmp_pd.o /usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/pd.c

deps_/usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/pd.o := \
  /usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/pd.c \
...
/usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/pd.o: $(deps_/usr/src/mlnx-en-3.0/drivers/net/ethernet/mellanox/mlx4/pd.o)
